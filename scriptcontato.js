// JavaScript para abrir e fechar o modal e implementar medidas anti-bot
document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(event) {
    ...
    const timeDiff = (currentTime - formLoadedAt) / 1000; // tempo em segundos

    if (timeDiff < 5) {  // Se o formulário for enviado em menos de 5 segundos, bloqueie o envio.
      alert("Você está preenchendo o formulário rápido demais! Por favor, tente novamente.");
      event.preventDefault();  // Impede o envio
      return;
    }

    // Opcional: Verificação adicional do Honeypot no frontend
